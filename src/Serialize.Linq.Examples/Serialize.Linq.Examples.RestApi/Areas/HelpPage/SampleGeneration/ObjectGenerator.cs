...
namespace Serialize.Linq.Examples.RestApi.Areas.HelpPage
{
    ...
    public class ObjectGenerator
    {
        ...
        /// Simple types: <see cref="Int32"/>, <see cref="String"/>, <see cref="Enum"/>, <see cref="DateTime"/>, <see cref="Uri"/>, etc.
        ...
        private class SimpleTypeObjectGenerator
        {
            ...
            private static Dictionary<Type, Func<long, object>> InitializeGenerators()
            {
                return new Dictionary<Type, Func<long, object>>
                {
                    ...
                    { typeof(short), index => (short)(index % Int16.MaxValue) },
                    { typeof(int), index => (int)(index % Int32.MaxValue) },
                    ...
                    { typeof(ushort), index => (ushort)(index % UInt16.MaxValue) },
                    { typeof(uint), index => (uint)(index % UInt32.MaxValue) },
